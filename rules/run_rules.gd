...
const UPGRADE_POOL: Array[StringName] = [&"anchor_coil", &"prism_lens", &"edge_fuse", &"recirculator", &"last_light"]
...
static func upgrade_rule(id: StringName) -> String:
	match id:
		...
		&"prism_lens": return "Standard rings 4–7\nscore +3."
