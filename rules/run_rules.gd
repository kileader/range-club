...
const UPGRADE_POOL: Array[StringName] = [&"quickset_string", &"stabilizing_sight", &"edge_fuse", &"recirculator", &"recovery_cell"]
...
static func upgrade_rule(id: StringName) -> String:
	match id:
		...
		&"recovery_cell": return "Focused misses refund\nthe spent Focus."
		_: return ""
